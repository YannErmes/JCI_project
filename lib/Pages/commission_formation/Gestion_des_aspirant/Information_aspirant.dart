...
class List_aspirant extends StatefulWidget {
  const List_aspirant({super.key});

  @override
  State<List_aspirant> createState() => _List_aspirantState();
}

class _List_aspirantState extends State<List_aspirant> {
