...
class formation_accuiell extends StatefulWidget {
  const formation_accuiell({super.key});

  @override
  State<formation_accuiell> createState() => _formation_accuiellState();
}

class _formation_accuiellState extends State<formation_accuiell> {
                          ...
                          Row(
                            children: [
                              CachedNetworkImage(imageUrl: 'https://i.pinimg.com/564x/84/62/e4/8462e4378ef0d8e4dec6d88ddf62727b.jpg'
                                , fit: BoxFit.cover,),
                              Expanded(
                                child: Txt("Espace Membre", Colors.white, 15) ,
                              )
                          ...
                          Selectctn(140, 140, Colors.blue,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Expanded(child:  Txt('Ajouté des membre', Colors.white, 16))
                                ],
                              )
                          ),
                          Selectctn(140, 140, Colors.blue,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Expanded(child:Txt('Infomation et status du membre', Colors.white, 16) )
